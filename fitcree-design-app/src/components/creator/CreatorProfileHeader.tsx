...
import { MapPin, BadgeCheck, Settings, Share2, Check } from 'lucide-react';

interface CreatorProfileHeaderProps {
  user: User;
}

export default function CreatorProfileHeader({ user }: CreatorProfileHeaderProps) {
  return (
        ...
        <div className="flex-grow min-w-0">
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
            ...
            <div className="flex flex-col gap-2 flex-shrink-0">
              ...
              <button
                onClick={() => alert('このページは準備中です')}
                className="flex items-center justify-center gap-2 w-full bg-white border border-neutral-200 text-neutral-700 font-bold py-3 px-4 rounded-lg hover:bg-neutral-50 transition-colors focus-visible:ring-2 focus-visible:ring-neutral-400 focus-visible:ring-offset-2"
              >
                ポートフォリオをシェア
