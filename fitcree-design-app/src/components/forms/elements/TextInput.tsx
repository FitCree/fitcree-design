...
export const TextInput = ({ value, onChange, placeholder, maxLength }: any) => (
  <div className="w-full">
    <input
      ...
      className="w-full bg-white p-3 border border-neutral-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-base text-neutral-800 transition-all"
    />
