  ...
  return (
    <header className="bg-white/80 backdrop-blur-md border-b border-neutral-200 fixed top-0 w-full z-50 h-14 flex items-center justify-between px-6 sm:px-12 transition-all">
      ...
      <div className="flex items-center gap-8">
        ...
        <div className="flex items-center">
          <Link href="/" className="flex items-center gap-2 group">
            <img src="/images/fitcree-logo.svg" alt="FitCree" className="h-5 md:h-6 w-auto" />
          </Link>
        </div>
      ...
      <div className="flex items-center gap-3 sm:gap-4">
        <Link
          href="/login"
          className="hidden md:flex items-center gap-2 px-4 py-2 text-sm text-neutral-800 hover:bg-neutral-50 rounded-full transition-all"
        >
          <LogIn size={18} />
          ログイン
        </Link>
